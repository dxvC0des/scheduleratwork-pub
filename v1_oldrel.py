...
This project was uploaded on github.
"""
...
class ScheduleApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Scheduler@Work - V1.0.5")
    ...
    def suggest_time(self):
        ...
        if response == True:  # If user clicks Yes
            webbrowser.open("https://docs.dxvprojects.org/school/public/scheduleai/")  # Open the website
